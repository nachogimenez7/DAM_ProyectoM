...
object RoleCatalog {
    ...
    private val stories = mapOf(
        RoleMap.MEDIEVAL to mapOf(
            ...
            ALCALDE to "Gobierna desde una silla demasiado grande y un salon demasiado lleno. Esta perdiendo la cordura entre rumores, copas servidas y ordenes que apenas recuerda, pero todavia conserva el poder de salvar o condenar al feudo.",
        ...
        RoleMap.GREECE to mapOf(
            ...
            MEDICO to "Aprendio a curar cuerpos entrenados para la guerra y estomagos vacios por culpa de la politica. Ante sus manos no importa si alguien invoca a Ares, a Atenea o a nadie; la sangre se seca igual en todos.",
